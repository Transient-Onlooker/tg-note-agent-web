/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f8fc9814d0e6f3193f9bed67ee0e63bc)
...
interface __BaseEnv_Env {
	...
	TELEGRAM_PRINT_WIZARD: DurableObjectNamespace<import("./src/index").TelegramPrintWizard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RealtimeHub" | "TelegramPrintWizard";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TELEGRAM_BOT_TOKEN" | "TELEGRAM_WEBHOOK_SECRET" | "TELEGRAM_ALLOWED_USER_ID">> {}
}
